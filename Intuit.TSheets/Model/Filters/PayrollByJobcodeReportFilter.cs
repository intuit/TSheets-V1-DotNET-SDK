// *******************************************************************************
// <copyright file="PayrollByJobcodeReportFilter.cs" company="Intuit">
...
namespace Intuit.TSheets.Model.Filters
{
    ...
    /// <summary>
    /// Filter for narrowing down the results of a call to retrieve <see cref="PayrollByJobcodeReport"/>.
    /// </summary>
    [JsonObject]
    public class PayrollByJobcodeReportFilter : EntityFilter
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PayrollByJobcodeReportFilter"/> class.
        /// </summary>
        public PayrollByJobcodeReportFilter()
        {
        }
        ...
        /// </param>
        public PayrollByJobcodeReportFilter(DateTimeOffset? startDate, DateTimeOffset? endDate)
        {
            StartDate = startDate;
            EndDate = endDate;
        }
