// *******************************************************************************
// <copyright file="ScheduleCalendarFilter.cs" company="Intuit">
...
namespace Intuit.TSheets.Model.Filters
{
    ...
    /// <summary>
    /// Filter for narrowing down the results of a call to retrieve <see cref="ScheduleCalendar"/> entities.
    /// </summary>
    [JsonObject]
    public class ScheduleCalendarFilter : EntityFilter
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets the filter for returning only those schedule calendars after before this date/time.
        /// </summary>
        [JsonConverter(typeof(DateTimeFormatConverter))]
