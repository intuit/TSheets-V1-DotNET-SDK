// *******************************************************************************
// <copyright file="GroupFilter.cs" company="Intuit">
...
namespace Intuit.TSheets.Model.Filters
{
    ...
    /// <summary>
    /// Filter for narrowing down the results of a call to retrieve <see cref="Group"/> entities.
    /// </summary>
    [JsonObject]
    public class GroupFilter : EntityFilter
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets the manager ids you'd like to filter on.
        /// </summary>
        [JsonConverter(typeof(EnumerableToCsvConverter))]
        [JsonSchema(JsonObjectType.String)]
        ...
        /// <summary>
        /// Gets or sets the filter for returning only those groups modified before this date/time.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the filter for returning only those groups modified after this date/time.
        /// </summary>
        [JsonConverter(typeof(DateTimeFormatConverter))]
