// *******************************************************************************
// <copyright file="UpdateContextValidator.cs" company="Intuit">
...
namespace Intuit.TSheets.Client.RequestFlow.PipelineElements
{
    ...
    internal class UpdateContextValidator : PipelineElement<UpdateContextValidator>
    {
        ...
        /// <summary>
        /// Ensures validity of the set of data entity items to be updated.
        /// </summary>
        ...
        protected override Task _ProcessAsync<T>(PipelineContext<T> context, ILogger logger)
        {
            ...
            if (updateContext.Items == null || !updateContext.Items.Any() || updateContext.Items.Any(i => i == null))
            {
