// *******************************************************************************
// <copyright file="CreateRequestSerializer.cs" company="Intuit">
...
namespace Intuit.TSheets.Client.RequestFlow.PipelineElements
{
    ...
    internal class CreateRequestSerializer : PipelineElement<CreateRequestSerializer>
    {
        ...
        /// be serialized on a create operation (i.e. Id, CreatedDate, etc.)
        /// </summary>
        ...
        /// <summary>
        /// Reads from the context object the set of entities to be created, and writes it back to 
        ...
        protected override Task _ProcessAsync<T>(PipelineContext<T> context, ILogger logger)
        {
            ...
            createContext.SerializedRequest = JsonConvert.SerializeObject(
                new Request<T>(createContext.Items), Formatting.Indented, SerializationConverter);
