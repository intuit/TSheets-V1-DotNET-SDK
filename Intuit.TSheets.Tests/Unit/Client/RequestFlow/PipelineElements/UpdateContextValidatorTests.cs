// *******************************************************************************
// <copyright file="UpdateContextValidatorTests.cs" company="Intuit">
...
namespace Intuit.TSheets.Tests.Unit.Client.RequestFlow.PipelineElements
{
    ...
    [TestClass]
    public class UpdateContextValidatorTests : UnitTestBase
    {
        private UpdateContextValidator pipelineElement;

        [TestInitialize]
        public override void Initialize()
        {
            base.Initialize();
            this.pipelineElement = UpdateContextValidator.Instance;
        }

        [TestMethod, TestCategory("Unit")]
        [ExpectedException(typeof(BadRequestException))]
        public async Task UpdateContextValidator_ThrowsWhenInputIdsIsNull()
        {
        ...
        [TestMethod, TestCategory("Unit")]
        [ExpectedException(typeof(BadRequestException))]
        public async Task UpdateContextValidator_ThrowsWhenInputIdsIsEmpty()
        {
